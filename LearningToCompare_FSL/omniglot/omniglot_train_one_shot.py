...
def main():
    ...
    for episode in range(EPISODE):
        ...
        # global a
        a = torch.zeros(BATCH_NUM_PER_CLASS*CLASS_NUM, CLASS_NUM).scatter(1, batch_labels.view(-1,1), 5)
        ...
        # one_hot_labels = Variable(batch_labels.view(-1,1).type(torch.FloatTensor)).cuda(GPU)
